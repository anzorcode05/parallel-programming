...
### Структура проекта
 ...
 `parallel-programming/`    
  ...
  `│   └── check_result.py       `   _# Скрипт верификации через NumPy  
  `├── data/            `  
  `│   ├── matrixA.txt  `   _# Входная матрица A_  
  `│   ├── matrixB.txt  `   _# Входная матрица B_  
  `│   └── matrixC.txt  `   _# Результирующая матрица C = A × B_  
  `├── gen_data.py      `   _# Скрипт генерации тестовых матриц_  
  `├──  run_experiments.py        `   _# Скрипт автоматического тестирования   
